...
Usage:
    python composition_anomaly_check.py Strepto_350_curated_only.fasta
    python composition_anomaly_check.py Aligned_350_primary.fasta
"""
import argparse
import re
...
def main():
    ...
    ap.add_argument("fasta", help="Aligned or unaligned FASTA containing the flagged accessions")
    args = ap.parse_args()
    ...
    print(f"\nFor comparison, dataset-wide GC z-score distribution (all {len(stats)} sequences):")
