...
Method
------
1. Load the ML tree (--treefile; an IQ-TREE .treefile).
...
Usage
-----
    python parsimony_permutation_test.py --treefile tree_350_primary.treefile
    python parsimony_permutation_test.py --treefile tree_346_sensitivity.treefile
    python parsimony_permutation_test.py --treefile tree_350_primary.treefile --exclude-composition-failing
    python parsimony_permutation_test.py --treefile tree_350_primary.treefile --leave-major-study-out
    python parsimony_permutation_test.py --treefile tree_350_primary.treefile --directly-reported-only
    python parsimony_permutation_test.py --treefile tree_350_primary.treefile --n-perm 9999 --seed 20260827
...
def run_test(treefile, known_labels, acc_to_country, n_perm, seed, label=""):
...
def main():
    ...
    ap.add_argument("--treefile", required=True, help="Path to an IQ-TREE .treefile")
    ...
    tree = dendropy.Tree.get(path=args.treefile, schema="newick", preserve_underscores=True)
    ...
    run_test(args.treefile, known_labels, acc_to_country, args.n_perm, args.seed, label=label)
